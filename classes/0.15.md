...
Response can be 
   ...
   [CLASS1.PROTOCOL, Type=50 (Start block data transfer ACK)](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.protocol.html#type50) 
   
   or 
   
   [CLASS1.PROTOCOL, Type=51 (Start block data transfer NACK)](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.protocol.html#type51).