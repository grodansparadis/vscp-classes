...
Response for event [CLASS1.PROTOCOL, Type=40 (Get event interest)](./class1.protocol.html#type40). The node report all events it is interested in. 
...
A node that is interested in everything just send a [CLASS1.PROTOCOL, Type=41 (Get event interest response)](./class1.protocol.html#type41) with no data.
